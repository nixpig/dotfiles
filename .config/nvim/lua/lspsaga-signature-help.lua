-- Automatically shows signature docs when typing methods.
-- Thanks to:
-- https://github.com/nvimdev/lspsaga.nvim/issues/145#issuecomment-841825657
-- https://github.com/nvimdev/lspsaga.nvim/issues/145#issuecomment-878850004
...
vim.cmd "autocmd InsertCharPre * lua require'lspsaga-signature-help'.lspsaga_open_signature_help()"
vim.cmd "augroup end"
